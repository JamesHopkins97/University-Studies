...
static float cubeVertices[36] =
{
	-5.0317f, 0.0f, 4.5618f, 1.0f,
	-5.0317f, 0.0f, -5.0317f, 1.0f,
	4.5618f, 0.0000f, -5.0317f, 1.0f,
	4.5618f, 0.0000f, 4.5618f, 1.0f,
	-5.0317f, 2.3197f, 4.5618f, 1.0f,
	4.5618f, 2.3197f, 4.5618f, 1.0f,
	4.5618f, 2.3197f, -5.0317f, 1.0f,
	-5.1f, 2.3f, -5.0f, 1.0f,
	-5.0317f, 0.0f, 4.5618f, 1.0f
};

// Per-vertex colours (RGBA) floating point values
static float cubeColours[36] =
{
	1.0f, 0.0f, 0.0f, 1.0f,
	1.0f, 1.0f, 0.0f, 1.0f,
	1.0f, 0.0f, 0.0f, 1.0f,
